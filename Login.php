...
<body>
	<div class="container">
		<form class="form-signin" action="Login.php" method="POST">
			<?php if(isset($_SESSION['email_id']) && !isset($_POST['logout']) && !isset($_GET['logout'])) { echo '<h2 class="form-signin-heading" align="center">'.$_SESSION['first_name'].'&nbsp;'.$_SESSION['last_name'].'</h2>'; } else { echo '<h2 class="form-signin-heading" align="center">Please sign in</h2>'; } ?>
			<img class="img-responsive img-circle center-block" width="170" height="170" <?php if(isset($_SESSION['email_id']) && !isset($_POST['logout']) && !isset($_GET['logout'])) { echo 'alt="user_dp" src="/AMOC/IMG/'.$_SESSION['email_id'].'.jpg"'; } ?> >
