...
<body>
	...
	<?php 
		if(isset($_POST['add'])) {
			...
			mysqli_query($connect,'INSERT INTO forum_questions(user_id,title,description) VALUES("$user_id","'.htmlentities(htmlspecialchars($_POST['title'],ENT_SUBSTITUTE),ENT_SUBSTITUTE).'","'.htmlentities(htmlspecialchars($_POST['description'],ENT_SUBSTITUTE),ENT_SUBSTITUTE).'")');
